...
MSG_HASH(
   ...
   "現在ロードされているものとは異なるビデオドライバに強制的に切り替えることをコアに許可します。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "古いテキストのみのシステムの代わりに、近代的な装飾されたアニメーション、通知、インジケータとコントロールを使用します。"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "ディスク上のシェーダーファイルに行われた変更を自動的に適用します。"
   )
MSG_HASH(
